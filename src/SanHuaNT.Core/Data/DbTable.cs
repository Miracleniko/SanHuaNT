...
namespace SanHuaNT.Data;

/// <summary>数据表</summary>
/// <remarks>
/// 文档 https://phoenixntx.com/core/dbtable
/// </remarks>
public class DbTable : IEnumerable<DbRow>, ICloneable, IAccessor
{
    ...
    public void ReadHeader(Binary bn)
    {
        ...
        if (magic != "SanHuaNTDbTable") throw new InvalidDataException();
    ...
    public void WriteHeader(Binary bn)
    {
        ...
        // 头部，幻数、版本和标记
        bn.Write("SanHuaNTDbTable".GetBytes(), 0, 14);
        bn.Write(_Ver);
        bn.Write(0);
