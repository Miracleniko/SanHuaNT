...
namespace SanHuaNT.DbCode.Code;
...
public class EntityBuilder : ClassBuilder
{
    ...
    protected virtual void AddNameSpace()
    {
        ...
        us.Add("SanHuaNT");
        us.Add("SanHuaNT.Data");
        us.Add("SanHuaNT.DbCode");
        us.Add("SanHuaNT.DbCode.Cache");
        us.Add("SanHuaNT.DbCode.Configuration");
        us.Add("SanHuaNT.DbCode.DataAccessLayer");
        //us.Add("SanHuaNT.DbCode.Common");
        if (Business) us.Add("SanHuaNT.DbCode.Shards");
        ...
        if (Business)
        {
            ...
            us.Add("SanHuaNT");
            us.Add("SanHuaNT.Model");
            us.Add("SanHuaNT.Log");
            us.Add("SanHuaNT.Reflection");
            us.Add("SanHuaNT.Threading");
            us.Add("SanHuaNT.Web");
            us.Add("SanHuaNT.DbCode.Cache");
            us.Add("SanHuaNT.DbCode.Membership");
            us.Add("SanHuaNT.DbCode.Shards");
        }
    }
    ...
    protected virtual void BuildMap()
    {
        ...
        foreach (var column in Table.Columns)
        {
            ...
            // 格式：表+主键+显示字段+属性名
            // Role@Id@Name
            // SanHuaNT.DbCode.Membership.Area@Id@Path@AreaPath
            // Tenant@Id@$
            // $表示用ToString()替代显示字段
    ...
    protected virtual void BuildHistory()
    {
        ...
        if (Convert.ToBoolean(needHistory.Value))
        {
            ...
            WriteLine("{");
            {
                ...
                WriteLine("SanHuaNT.DbCode.Common.DataConversion.CopyProperty(entity, entityHistory);");
