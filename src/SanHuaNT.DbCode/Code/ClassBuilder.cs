...
public class ClassBuilder
{
    ...
    public virtual void Execute()
    {
        ...
        foreach (var dc in dt.Columns)
        {
            if (dc.DataType == null && dc.Properties["Type"].IsNullOrEmpty())
                throw new DbCodeException($"表[{dt.Name}]的字段[{dc.Name}]未指定DataType类型");
        }
    ...
    protected virtual void OnExecuting()
    {
        ...
        //if (Option.HasIModel)
        //{
        //    if (!us.Contains("SanHuaNT.Data")) us.Add("SanHuaNT.Data");
        //    if (!us.Contains("SanHuaNT.Reflection")) us.Add("SanHuaNT.Reflection");
        //}
