...
public static class EntityFactory
{
    ...
    public static IEntityFactory CreateFactory(Type type)
    {
        ...
        //if (!_factories.TryGetValue(type, out factory)) throw new SanHuaNT.DbCodeException("无法创建[{0}]的实体工厂！", type.FullName);
        ...
        if (factory == null) throw new DbCodeException("无法创建[{0}]的实体工厂！", type.FullName);
