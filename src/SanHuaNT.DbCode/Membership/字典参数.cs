...
public partial class Parameter : IParameter, IEntity<ParameterModel>
{
    ...
    private SanHuaNT.DbCode.Membership.ParameterKinds _Kind;
    /// <summary>种类。0普通，21列表，22名值</summary>
    [DisplayName("种类")]
    [Description("种类。0普通，21列表，22名值")]
    [DataObjectField(false, false, false, 0)]
    [BindColumn("Kind", "种类。0普通，21列表，22名值", "")]
    public SanHuaNT.DbCode.Membership.ParameterKinds Kind { get => _Kind; set { if (OnPropertyChanging("Kind", value)) { _Kind = value; OnPropertyChanged("Kind"); } } }
    ...
    public override Object? this[String name]
    {
        ...
        set
        {
            switch (name)
            {
                ...
                case "Kind": _Kind = (SanHuaNT.DbCode.Membership.ParameterKinds)value.ToInt(); break;
