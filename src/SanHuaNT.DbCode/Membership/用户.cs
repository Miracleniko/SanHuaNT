...
using SanHuaNT;
using SanHuaNT.Data;
using SanHuaNT.DbCode;
using SanHuaNT.DbCode.Cache;
using SanHuaNT.DbCode.Configuration;
using SanHuaNT.DbCode.DataAccessLayer;

namespace SanHuaNT.DbCode.Membership;
...
public partial class User : IUser, IEntity<UserModel>
{
    ...
    private SanHuaNT.DbCode.Membership.SexKinds _Sex;
    /// <summary>性别。未知、男、女</summary>
    [DisplayName("性别")]
    [Description("性别。未知、男、女")]
    [DataObjectField(false, false, false, 0)]
    [BindColumn("Sex", "性别。未知、男、女", "")]
    public SanHuaNT.DbCode.Membership.SexKinds Sex { get => _Sex; set { if (OnPropertyChanging("Sex", value)) { _Sex = value; OnPropertyChanged("Sex"); } } }
    ...
    public override Object? this[String name]
    {
        ...
        set
        {
            switch (name)
            {
                ...
                case "Sex": _Sex = (SanHuaNT.DbCode.Membership.SexKinds)value.ToInt(); break;
    ...
    public SanHuaNT.DbCode.Membership.Area? Area => Extends.Get(nameof(Area), k => SanHuaNT.DbCode.Membership.Area.FindByID(AreaId));

    /// <summary>地区</summary>
    [Map(nameof(AreaId), typeof(SanHuaNT.DbCode.Membership.Area), "ID")]
