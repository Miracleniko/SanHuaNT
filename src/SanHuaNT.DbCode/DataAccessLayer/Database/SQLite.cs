...
internal class SQLite : FileDbBase
{
    ...
    /// <returns></returns>
    public override String PageSplit(String sql, Int64 startRowIndex, Int64 maximumRows, String keyColumn) => SqlServer.PageSplitByLimit(sql, startRowIndex, maximumRows);
    ...
    public override SelectBuilder PageSplit(SelectBuilder builder, Int64 startRowIndex, Int64 maximumRows) => SqlServer.PageSplitByLimit(builder, startRowIndex, maximumRows);
    #endregion
